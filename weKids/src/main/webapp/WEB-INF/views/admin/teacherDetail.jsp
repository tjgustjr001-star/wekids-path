    ...
    <div class="teacher-detail-grid">
        <div class="teacher-detail-left">
            <section class="panel-card teacher-profile-card">
                <div class="teacher-profile-avatar">👤</div>
                ...
                <div class="teacher-info-list">
                    ...
                    <div class="teacher-info-item">
                        <strong>생년월일</strong>
                        <span><fmt:formatDate value="${teacher.birth}" pattern="yyyy.MM.dd"/></span>
                    </div>

                    <div class="teacher-info-item">
                        <strong>가입일</strong>
                        <span><fmt:formatDate value="${teacher.joinDate}" pattern="yyyy.MM.dd"/></span>
                    </div>

                    <div class="teacher-info-item">
                        <strong>최근 로그인</strong>
                        <span><fmt:formatDate value="${teacher.lastLoginAt}" pattern="yyyy.MM.dd HH:mm"/></span>
                    </div>
                            ...
                            <c:forEach items="${classList}" var="cls">
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <td><fmt:formatDate value="${cls.startDate}" pattern="yyyy.MM.dd"/></td>
                                    <td><fmt:formatDate value="${cls.endDate}" pattern="yyyy.MM.dd"/></td>
                                </tr>
                            </c:forEach>

                            <c:if test="${empty classList}">
                                <tr>
                                    <td colspan="6" style="text-align:center; padding:30px;">운영 중인 클래스가 없습니다.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
