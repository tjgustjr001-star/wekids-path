...
<div class="admin-users-page">
    ...
    <div class="page-header-row">
        <div>
            ...
            <p class="page-desc">학생과 학부모 계정을 조회하고 상태를 관리합니다.</p>
        </div>
        <div class="page-header-actions">
        <button type="button" class="primary-btn" id="openCreateStudentModalBtn">학생 계정 생성</button>
    </div>
    </div>
    ...
    <div class="users-top-grid">
        ...
        <section class="panel-card">
            <h2 class="panel-title">사용자 현황</h2>
            <div class="user-stat-box">
                ...
                <div class="user-stat-row">
                    <span>학부모</span>
                    <strong>${parentCount}명</strong>
                </div>
                <div class="user-stat-row">
                    <span>전체</span>
                    <strong id="userTotalCount">${totalUserCount}명</strong>
                </div>
            </div>
        </section>
    </div>
    ...
    <section class="users-board">
        <div class="users-board-top">
            ...
            <div class="search-box">
                <input type="text" id="userSearchInput" placeholder="이름, 아이디, 이메일 검색">
            </div>
        </div>
            ...
            <table class="user-table" id="userTable">
                ...
                <tbody>
                        ...
                        <tr class="user-row"
                            ...
                            <td class="manage-cell">
                                <div class="table-action-wrap">
                                    <a href="${pageContext.request.contextPath}/admin/users/${user.memberId}" class="detail-link-btn">상세 보기</a>
                                        ...
                                        <div class="table-row-menu">
                                            <form action="${pageContext.request.contextPath}/admin/users/status" method="post">
                                                ...
                                                <button type="submit" class="teacher-status-action">계정 활성화</button>
                                            </form>
                    ...
                    <c:if test="${empty userList}">
                        <tr>
                            <td colspan="8" style="text-align:center; padding:30px;">조회된 사용자 정보가 없습니다.</td>
                        </tr>
                    </c:if>
                </tbody>
            </table>
        ...
        <div class="users-board-footer">
            <span>총 <span id="userCountText">${totalUserCount}</span>명</span>
        </div>
    </section>
</div>
<div class="teacher-modal" id="createStudentModal">
    <div class="teacher-modal-dialog">
        <div class="teacher-modal-header">
            <h3>학생 계정 생성</h3>
            <button type="button" class="close-modal-btn" id="closeCreateStudentModalBtn">×</button>
        </div>
        ...
        <form id="createStudentForm"
            ...
            <div>
                <label>학생 이름 <span class="required-mark">*</span></label>
                <input type="text" name="studentName" id="studentNameInput" placeholder="예: 김학생">
            </div>

            <div>
                <label>로그인 아이디 <span class="required-mark">*</span></label>
                <input type="text" name="loginId" id="studentLoginIdInput" placeholder="예: s006">
            </div>

            <div>
                <label>이메일 <span class="required-mark">*</span></label>
                <input type="email" name="email" id="studentEmailInput" placeholder="student@daewoo.edu.kr">
            </div>

            <div>
                <label>초기 비밀번호 <span class="required-mark">*</span></label>
                <input type="text" name="initialPassword" id="studentPasswordInput" placeholder="초기 비밀번호 입력">
            </div>

            <div class="teacher-modal-actions">
                <button type="button" class="modal-cancel-btn" id="cancelCreateStudentBtn">취소</button>
