...
<section class="teacher-learn-manage-page">
    <div class="class-page-hero">
        ...
        <div class="class-page-hero-text">
            <h1 class="class-page-hero-title">학습 관리</h1>
                        ...
                        <c:when test="${not empty learnList}">
                            <c:forEach var="learn" items="${learnList}">
                                <div class="teacher-learn-row"
                                     ...
                                     data-completed-count="${learn.completedCount}"
									data-in-progress-count="${learn.inProgressCount}"
									data-not-started-count="${learn.notStartedCount}"
									data-completion-rate="${learn.completionRate}"
									data-total-student-count="${learn.totalStudentCount}"
                                     >
...
<div class="teacher-modal-backdrop" id="learnDetailModal">
    <div class="teacher-modal teacher-learn-detail-modal">
        ...
        <div class="teacher-modal-body scrollable teacher-learn-detail-scroll">
    ...
    <div class="detail-progress-summary-card">
        <div class="detail-progress-header">
            <strong>전체 진행률</strong>
            <strong id="detailCompletionRateText">0%</strong>
        </div>

        <div class="detail-progress-bar">
            <div class="detail-progress-bar-fill" id="detailCompletionBar"></div>
        </div>

        <div class="detail-progress-count-grid">
            <div class="detail-progress-count-box">
                <span>완료</span>
                <strong class="complete" id="detailCompletedCount">0명</strong>
            </div>
            <div class="detail-progress-count-box">
                <span>진행중</span>
                <strong class="progress" id="detailInProgressCount">0명</strong>
            </div>
            <div class="detail-progress-count-box">
                <span>미시작</span>
                <strong class="not-started" id="detailNotStartedCount">0명</strong>
            </div>
        </div>
    </div>

    <div class="detail-student-progress-section">
        <h4 class="detail-section-title">학생별 진행 상황 (<span id="detailStudentCount">0</span>명)</h4>
        <div class="detail-student-progress-list" id="detailStudentProgressList">
            <div class="teacher-empty-box">학생 진행 상황을 불러오는 중입니다.</div>
        </div>
    </div>
</div>
