                        ...
                        <c:when test="${not empty studentList}">
                            <c:forEach var="student" items="${studentList}">
                                <div class="teacher-student-row"
                                     ...
                                     data-last-login="${student.lastLogin}"
                                     data-learning-progress="${student.learningProgress}"
                                     data-recent-assignments="${student.recentAssignments}"
                                     data-feedback-sum="${student.feedbackSummary}"
                                     data-tags="${student.tagsCsv}"
                                     data-memo="${student.memo}">
                                    <div class="col no">
                                        ...
                                        <div class="student-info-wrap">
                                            ...
                                            <div class="student-meta">
                                                ...
                                                <div class="student-parent-link">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${student.parentLinked}">
                                    ...
                                    <div class="col login">
                                        <span class="student-last-login">${student.lastLogin}</span>
                                    </div>
                                    ...
                                    <div class="col progress">
                                        <div class="progress-cell">
                                            <div class="progress-text-row">
                                                <span>전체 달성률</span>
                                                <strong class="${student.learningProgress lt 60 ? 'danger-text' : 'normal-text'}">
                                                    ${student.learningProgress}%
                                                </strong>
                                            </div>

                                            <div class="progress-bar">
                                                <div class="progress-fill ${student.learningProgress lt 60 ? 'danger' : ''}"
                                                     style="width:${student.learningProgress}%;"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="student-manage-wrap">
                                            ...
                                            <div class="row-menu-wrap">
                                                ...
                                                <div class="row-menu-dropdown">
                                                    ...
                                                    <button type="button" class="row-menu-item danger">클래스 제외</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
