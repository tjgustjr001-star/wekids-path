    ...
    <div class="popup_box required_popup_box">
        <div class="popup_header required_popup_header">
            <div class="popup_header_left">
                <span class="popup_alert_icon">
                    <img src="${pageContext.request.contextPath}/resources/images/warning.png" alt="알림">
                </span>
                <div>
                    <h3>읽지 않은 필독 공지 ${requiredUnreadCount}건</h3>
                    <p>아래 공지를 확인하고 읽음 확인 버튼을 눌러주세요.</p>
                </div>
            </div>
            <button type="button" id="closeRequiredPopupBtn" class="popup_close_btn">×</button>
        </div>
            ...
            <c:forEach var="notice" items="${noticeList}">
                <c:if test="${isStudentOrParent and (notice.requiredUnread or notice.confirmYn eq 1) and not notice.readConfirmed}">
                    <div class="required_item"
                         data-notice-id="${notice.noticeId}"
                         data-class-id="${classId}">
                        <div class="required_item_icon">
                            <img src="${pageContext.request.contextPath}/resources/images/warning.png" alt="필독">
                        </div>
                        <div class="required_item_text">
                        ...
                        <span class="required_item_badge">필독</span>
                    </div>
                </c:if>
            </c:forEach>
        </div>
