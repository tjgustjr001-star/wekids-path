...
<body>
    <div class="intro-page">
        ...
        <main class="intro-main">
            ...
            <p class="intro-desc">
                교사, 학생, 학부모가 함께 만드는 안전하고 즐거운 교육 커뮤니티입니다.<br>
                지금 바로 시작해보세요.
            </p>
            ...
            <div class="intro-card-section">
                <div class="intro-card student-card">
                    <div class="card-badge badge-student">학생</div>
                ...
                <div class="intro-card teacher-card">
                    <div class="card-badge badge-teacher">교사</div>
                ...
                <div class="intro-card parent-card">
                    <div class="card-badge badge-parent">부모</div>
                    <h3 class="card-title">학부모의 참여</h3>
                    <p class="card-desc">
                        자녀의 연결 코드로 보호자 등록 후 학생의 학습현황을 확인합니다.
                    </p>
                </div>
            </div>
        </main>
